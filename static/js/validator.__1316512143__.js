...
(function() {
	...
	function ValidatorElement(fieldName)
	{
        ...
        this.setIsNumber = function(bool)
        {
	...
	var FormValidator = {
		...
		{
			if (FormValidator.validators[fieldName]) {
				return FormValidator.validators[fieldName];
			}
		...
		submitHandler : function(e)
		{
            ...
            for (var i=0; i<vForm.formCallbacks.length; i++){
